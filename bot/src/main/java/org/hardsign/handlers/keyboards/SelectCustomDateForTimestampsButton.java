...
public class SelectCustomDateForTimestampsButton extends BaseTextUpdateHandler implements KeyboardPressHandler {

    private final TelegramBot bot;
    private final UserStateService userStateService;

    public SelectCustomDateForTimestampsButton(TelegramBot bot, UserStateService userStateService) {
        this.bot = bot;
    ...
    protected String expectedText() {
        return ButtonNames.CUSTOM_DATE_TIMESTAMPS.getName();
    }
